...
class Completed_Order extends StatefulWidget {
  const Completed_Order({super.key});

  @override
  State<Completed_Order> createState() => _Completed_Order();
}

class _Completed_Order extends State<Completed_Order> {
  //List Order
  String Username = "";
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => OrderDetailComPage(
