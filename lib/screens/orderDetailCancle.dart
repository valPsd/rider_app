...
class OrderDetailCPage extends StatefulWidget {
  OrderDetailCPage({super.key, required this.Orderid});
  String Orderid;
  @override
  State<OrderDetailCPage> createState() => _OrderDetailCState();
}

class _OrderDetailCState extends State<OrderDetailCPage> {
  void showalert() {
    QuickAlert.show(
        context: context,
